...
**                                                                           **
******************************************************************************/
/*  TRACEABILITY :[cover parentID=DS_AS_ICU038,DS_AS_ICU275,
                   ...
                   DS_AS40X_ICU351_ICU352,SAS_NAS_ALL_PR746,SAS_NAS_ALL_PR748,
                   SAS_MCAL_ICU_0008,SAS_MCAL_ICU_0009,SAS_MCAL_ICU_0010,
                   SAS_MCAL_ICU_0011,DS_NAS_ICU_PR3054,DS_AS40X_ICU001_PI]
                   [/cover]                                                  */ 
...
#include "Det.h"
     ...
     (ICU_USER_MODE_RUNTIME_API_ENABLE == STD_ON) || \
     (ICU_USER_MODE_DEINIT_API_ENABLE == STD_ON) || \
     (ICU_RUNNING_IN_USER_0_MODE_ENABLE == STD_ON))
           #include "Icu_17_GtmCcu6_Protect.h"
#endif
...
#define TIMEBASE_TBU_TS0 (0U)
#define TIMEBASE_TBU_TS1 (1U)
#define TIMEBASE_TBU_TS2 (2U)
/*
...
/* In Icu_17_GtmCcu6_Init function CCU6 clock
   initiization is failed */
#define ICU_E_PARAM_CLC_ERROR     ((uint8)0x35)

/* Error reporting in case of unexpected triggering of
   service requests or call of a wrong ISR  */
#define ICU_E_INTR_SRC_ERROR     ((uint8)0x36)

#endif
/* Icu_17_GtmCcu6_EnableMultiEdgeDetection called with a 
  EdgeCount parameter as zero */
#define ICU_E_PARAM_EDGE_NUMBER   ((uint8)0x21)
...
/* API Service ID for Gtm Isr*/
#define ICU_SID_GTMISR                            ((uint8)0x18)
/* API Service ID for Icu_17_GtmCcu6_EnableMultiEdgeDetection */
#define ICU_SID_ENABLEMULTIEDGEDETECTION          ((uint8)0x19)
/* API Service ID for Ccu6 Isr*/
#define ICU_SID_CCU6ISR                           ((uint8)0x1A)
/* API Service ID for Eru Isr*/
#define ICU_SID_ERUISR                            ((uint8)0x1B)
...
#define INPUT_OF_CURRENT_TIM_CHANNEL  (0U)
#define INPUT_OF_PREVIOUS_TIM_CHANNEL  (1U)
...
#define ICU_GTM_TIM_CICTRL_POS  ((unsigned_int)6UL)
...
#define ICU_SRC_SCU_ERU_CLEAR_MASK (0x7FFFFFFFUL)
#define ICU_SRC_SCU_ERU_SRPN_MASK (0x000000FFUL)
#define ICU_SRC_CCU6_CLEAR_MASK (0x7FFFFFFFUL)
#define ICU_SRC_CCU6_SRE_SET_MASK (0x00000400UL)
#define ICU_SRC_CCU6_SRE_CLEAR_MASK (0x7FFFFBFFUL)
#define ICU_COMMON_SET_MASK (0x00000000UL)
#define ICU_COMMON_CLEAR_MASK (0xFFFFFFFFUL)
#define ICU_GTM_TIM_CH_FLT_RE_MASK (0x00FFFFFFUL)
#define ICU_GTM_TIM_CH_FLT_FE_MASK (0x00FFFFFFUL)
#define ICU_GTM_TIM_CH_IRQ_MODE_MASK (0x00000003UL)
#define ICU_GTM_TIM_CH_CTRL_TIM_MODE_POS 1U
#define ICU_GTM_TIM_CH_IRQ_ENABLE (1UL)
#define ICU_GTM_TIM_CH_IRQ_DISABLE (0UL)
#define ICU_GTM_TIM_ACTIVE_TIME_MASK (0x00FFFFFFUL)
#define ICU_GTM_TIM_PERIOD_TIME_MASK (0x00FFFFFFUL)
#define ICU_CCU6_CLC_DISS_MASK (0x00000002UL)
#define ICU_CCU6_CLC_DISS_POS 1U
#define ICU_CCU6_CLC_DISR_CLEAR_MASK (0xFFFFFFFEUL)
#define ICU_CCU6_CLC_DISR_SET_MASK (0x00000001UL)
#define ICU_CCU6_CLC_EDIS_SET_MASK (0x08UL)
#define ICU_CCU6_CLC_EDIS_CLEAR_MASK (0xFFFFFFF7UL)
#define ICU_CCU6_TCTR4_T12RR_SET_MASK (0x00000001UL)
#define ICU_CCU6_TCTR4_T12RS_SET_MASK (0x00000002UL)
#define ICU_CCU6_TCTR4_T12STR_SET_MASK (0x00000040UL)
#define ICU_SRC_SCU_ERU_SRE_SET_MASK (0x00000400UL)
#define ICU_RUNTIME_ACCESS                    1U
#define ICU_INIT_ACCESS                       2U
#define ICU_DEINIT_ACCESS                     3U

#define IMMEDIATE_EDGE_PROPAGATION_MODE 0U
#define DEGLITCH_WITH_HOLD_COUNTER  3U
#define DEGLITCH_WITH_UPDOWN_COUNTER  1U

#if (ICU_USER_MODE_INIT_API_ENABLE == STD_ON) 
#define ICU_SFR_INIT_RESETENDINIT()                 ICU_INIT_RESETENDINIT()
#define ICU_SFR_INIT_SETENDINIT()                   ICU_INIT_SETENDINIT()
#define ICU_SFR_INIT_WRITE32(reg,value)             ICU_INIT_WRITE32(reg, value)
#define ICU_SFR_INIT_MODIFY32(reg,clearmask,setmask) \
                                       ICU_INIT_MODIFY32(reg,clearmask,setmask);
#if (ICU_RUNNING_IN_USER_0_MODE_ENABLE == STD_ON)
    #define ICU_SFR_INIT_USER_MODE_WRITE32(reg,value) \
                                  ICU_INIT_USER_MODE_OS_API_WRITE32(reg,value)
    #define ICU_SFR_INIT_USER_MODE_READ32(reg) \
                                          ICU_INIT_USER_MODE_OS_API_READ32(reg)
    #define ICU_SFR_INIT_USER_MODE_MODIFY32(reg,clearmask,setmask) \
                      ICU_INIT_USER_MODE_OS_API_MODIFY32(reg,clearmask,setmask);
    #define ICU_SFR_INIT_USER_MODE_SETATOMIC(Address,Value,Offset,Bits) \
                              ICU_INIT_SETATOMIC(Address,Value,Offset,Bits)
#else
  #define ICU_SFR_INIT_USER_MODE_WRITE32(reg,value)         ((reg) = (value))
    #define ICU_SFR_INIT_USER_MODE_READ32(reg)                 (reg)
    #define ICU_SFR_INIT_USER_MODE_MODIFY32(reg,clearmask,setmask) \
...
#endif /* ICU_RUNNING_IN_USER_MODE_ENABLE == STD_ON  */
#else
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define ICU_SFR_INIT_RESETENDINIT()                  (Mcal_ResetENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define ICU_SFR_INIT_WRITE32(reg,value)              ((reg) = (value))
/*IFX_MISRA_RULE_19_04_STATUS=First level of indirection is used to support
modification of OS protected calls, so it cannot be expand to a braced
 initialiser*/
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
...
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/     
#define ICU_SFR_INIT_SETENDINIT()                      (Mcal_SetENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/ 
#define ICU_SFR_INIT_USER_MODE_WRITE32(reg,value)     ((reg) = (value))
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
...
/*ICU UserMode is enabled*/
#if (ICU_RUNNING_IN_USER_0_MODE_ENABLE == STD_ON)
      #define ICU_SFR_RUNTIME_USER_MODE_WRITE32(reg,value) \
                               ICU_RUNTIME_USER_MODE_OS_API_WRITE32(reg,value)
      #define ICU_SFR_RUNTIME_USER_MODE_READ32(reg)  \
                               ICU_RUNTIME_USER_MODE_OS_API_READ32(reg)      
      #define ICU_SFR_RUNTIME_USER_MODE_MODIFY32(reg,clearmask,setmask) \
                  ICU_RUNTIME_USER_MODE_OS_API_MODIFY32(reg,clearmask,setmask);
      #define ICU_SFR_RUNTIME_USER_MODE_SETATOMIC(Address,Value,Offset,Bits) \
                              ICU_RUNTIME_SETATOMIC(Address,Value,Offset,Bits)
#else
    /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define ICU_SFR_RUNTIME_USER_MODE_WRITE32(reg,value)      ((reg) = (value))
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
    #define ICU_SFR_RUNTIME_USER_MODE_READ32(reg)               (reg)
    /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
    #define ICU_SFR_RUNTIME_USER_MODE_MODIFY32(reg,clearmask ,setmask) \
      { uint32 val ; val = (uint32)(reg) ; val &= (uint32)(clearmask); \
...
#define ICU_SFR_DEINIT_RESETENDINIT()            ICU_DEINIT_RESETENDINIT()
#define ICU_SFR_DEINIT_SETENDINIT()              ICU_DEINIT_SETENDINIT()
#define ICU_SFR_DEINIT_WRITE32(reg,value)        ICU_DEINIT_WRITE32(reg, value)
#define ICU_SFR_DEINIT_MODIFY32(reg,clearmask,setmask)  \
                                     ICU_DEINIT_MODIFY32(reg,clearmask,setmask);
#if (ICU_RUNNING_IN_USER_0_MODE_ENABLE == STD_ON)
      #define ICU_SFR_DEINIT_USER_MODE_WRITE32(reg,value) \
                                  ICU_DEINIT_USER_MODE_OS_API_WRITE32(reg,value)
      #define ICU_SFR_DEINIT_USER_MODE_READ32(reg) \
                                        ICU_DEINIT_USER_MODE_OS_API_READ32(reg)
      #define ICU_SFR_DEINIT_USER_MODE_MODIFY32(reg,clearmask,setmask) \
                    ICU_DEINIT_USER_MODE_OS_API_MODIFY32(reg,clearmask,setmask);
    #define ICU_SFR_DEINIT_USER_MODE_SETATOMIC(Address,Value,Offset,Bits) \
                              ICU_DEINIT_SETATOMIC(Address,Value,Offset,Bits)
#else
    /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define ICU_SFR_DEINIT_USER_MODE_WRITE32(reg,value)    ((reg) = (value))
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
    #define ICU_SFR_DEINIT_USER_MODE_READ32(reg)             (reg)
 /*IFX_MISRA_RULE_19_04_STATUS=First level of indirection is used to support
  modification of OS protected calls, so it cannot be expand to a braced
 initialiser*/
    /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
...
#define ICU_SFR_DEINIT_USER_MODE_SETATOMIC(Address,Value,Offset,Bits) \
    ...
    /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define ICU_SFR_DEINIT_RESETENDINIT()            (Mcal_ResetENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define ICU_SFR_DEINIT_WRITE32(reg,value)       ((reg) = (value))
/*IFX_MISRA_RULE_19_04_STATUS=First level of indirection is used to support
modification of OS protected calls, so it cannot be expand to a braced
 initialiser*/
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
...
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
 calls definition, it is declared as a function like macro*/
#define ICU_SFR_DEINIT_SETENDINIT()               (Mcal_SetENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/ 
#define ICU_SFR_DEINIT_USER_MODE_WRITE32(reg,value)   ((reg) = (value))
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
...
** Traceability:     [cover parentID=DS_AS_ICU212,DS_AS_ICU050_21_ICU346,
   ...
   DS_AS_ICU183,DS_NAS_ICU_PR734_21,DS_AS_ICU094_ICU347,DS_NAS_ICU_PR128,
   DS_NAS_ICU_PR115]
...
/* [cover parentID=DS_AS_ICU294,DS_NAS_ICU_PR643_3] */ 
...
*/
/* [cover parentID=DS_NAS_ICU_PR643_4] */
...
/* 
 ...
 ICU_CIRCULAR_BUFFER 
*/
/* [cover parentID=DS_AS_ICU296,DS_NAS_ICU_PR643_5] */
...
*/
/* [cover parentID=DS_AS_ICU258_ICU277,DS_NAS_ICU_PR643_6] */
typedef uint8 Icu_17_GtmCcu6_ModeType;  
/* [/cover]  */

/* Input state of an ICU channel.  */
/* [cover parentID=DS_AS_ICU279,DS_NAS_ICU_PR643_7] */
...
/* [/cover] */
/* [cover parentID=DS_NAS_ICU_PR643_2] */
...
/* [cover parentID=DS_AS_ICU289,DS_NAS_ICU_PR643_1] */
...
typedef uint8 Icu_17_GtmCcu6_GprType;
  ...
  */
  ...
  struct
  {
    ...
    */
    ...
    /* Gpr0 input select for the Tim channel */
    Icu_17_GtmCcu6_GprType TimChannelGpr0InputSelect; 
    /* Enables Filter for the Channel */
...
typedef struct Icu_SigMeasurementParasType
{
  ...
  uint8         SigProp;
  #if (ICU_SAFETY_ENABLE == STD_ON)  
 /* Signal measurement Buffer Marker for validating the correct buffer 
    pointer */
...
*******************************************************************************/
#if (ICU_EDGE_DETECT_API == STD_ON)
extern void Icu_17_GtmCcu6_EnableMultiEdgeDetection 
                (Icu_17_GtmCcu6_ChannelType Channel, uint32 EdgeCount);
#else
/*IFX_MISRA_RULE_19_07_STATUS=Function like macro used to generate 
 compile time error in case of incorrect configuration*/
#define Icu_17_GtmCcu6_EnableMultiEdgeDetection(Channel)                     \
                        (ERROR_Icu_17_GtmCcu6_EnableEdgeDetection_NOT_SELECTED)
#endif
...
/*IFX_MISRA_RULE_19_07_STATUS=Function like macro used to generate 
 compile time error in case of incorrect configuration*/
#define Icu_17_GtmCcu6_StopTimestamp(Channel) \
                 (ERROR_IcuTimeStampApi_NOT_SELECTED)
#endif
...
**                   Service request will be invoked.                        **
*****************************************************************************/
extern void Icu_17_GtmCcu6_Ccu_Isr(uint8 CcuKernalNumber);
...
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for inline functions defined in 
  header files */
_IFXEXTERN_ IFX_INLINE uint8 Icu_lGetEdge(
...
extern const Icu_17_GtmCcu6_ConfigType Icu_ConfigRoot[ICU_CONFIG_COUNT];
