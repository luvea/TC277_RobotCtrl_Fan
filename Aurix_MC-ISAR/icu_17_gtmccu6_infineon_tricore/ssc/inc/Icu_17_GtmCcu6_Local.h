...
/*IFX_MISRA_RULE_08_08_STATUS= This violation is reported incorrectly
   by PC-lint tool  */
...
/* TIM Enable */
#define ICU_GTM_TIM_ENABLE_CHANNEL ((unsigned_int)1UL)
...
#define ICU_TIM_CTRL_DSL_POS (13U)


#define ICU_TIM_CTRL_GPR0SELBIT1_POS (9U)
...
/* [cover parentID=DS_MCAL_ICU_0003] */ 
/* --------------------------------------------------------------
...
/* [cover parentID=DS_MCAL_ICU_0004] */ 
/* --------------------------------------------------------------
...
/* [cover parentID=DS_MCAL_ICU_0002] */ 
/* --------------------------------------------------------------
...
/* [cover parentID=DS_MCAL_ICU_0005] */
...
_IFXEXTERN_ IFX_INLINE Icu_17_GtmCcu6_ChannelType Icu_lGetEruInputLineUsed(
                                      Icu_17_GtmCcu6_ChannelType CellUsed); 

_IFXEXTERN_ IFX_INLINE uint32 Icu_lGetEruExisPos(uint32 EruEicrChannel);

_IFXEXTERN_ IFX_INLINE void Icu_lSetEruExis(
                               Icu_17_GtmCcu6_ChannelType EruInputLineUsed, 
                               Icu_17_GtmCcu6_ChannelType EruEicrUsed, 
                               Icu_17_GtmCcu6_ChannelType EruEicrChannel);
                                 
_IFXEXTERN_ IFX_INLINE uint32 Icu_lGetErulinePos(uint32 LineNum);   

_IFXEXTERN_ IFX_INLINE volatile unsigned_int* Icu_lGetEruAddress(
                                   Icu_17_GtmCcu6_ChannelType EicrNumber);
#endif                                   
                                  
_IFXEXTERN_ uint8 Icu_17_lGlbIndexStatusExtract 
               (Icu_17_GtmCcu6_ChannelType Channel, uint8 ChlIndex, 
               uint8 ChlLength);

_IFXEXTERN_ IFX_INLINE uint8 Icu_lGtmGetIrqMode8(uint8 Word);

#if (ICU_INITCHECK_API == STD_ON)
#if ((ICU_TIM_SIGEDGE_USED == STD_ON) &&(ICU_EDGE_DETECT_API == STD_ON))
 _IFXEXTERN_ IFX_INLINE uint32 Icu_lGtmStartEdgeDetectCheck(
...
_IFXEXTERN_ IFX_INLINE uint8 Icu_lGetGtmModuleNo
                     (Icu_17_GtmCcu6_ChannelIdentifierType ChannelId);

_IFXEXTERN_  IFX_INLINE uint8 Icu_lCcu6GetActiveEdge
                        (Icu_17_GtmCcu6_ActivationType ActiveEdge);

_IFXEXTERN_ IFX_INLINE uint8 Icu_lGetChannelType
                                (Icu_17_GtmCcu6_ChannelType Channel);
                                
#if (ICU_CCU6_USED == STD_ON)
_IFXEXTERN_ IFX_INLINE Ifx_CCU6* Icu_lCcuGetBaseAddress(uint8 CellUsed);
#endif
...
/*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access*/ 
 ...
 /* Checking value of TIM_EN bit in TIM_CH_CTRL*/
  if ((ICU_SFR_INIT_USER_MODE_READ32(TimChannelRegPtr->CH_CTRL.U) & 
                      ICU_GTM_TIM_ENABLE_CHANNEL) != ICU_GTM_TIM_ENABLE_CHANNEL)
  {
    CompareFlag = 0U;
  }
  else
...
#if (ICU_GTM_TIM_USED == STD_ON)
/******************************************************************************
** Syntax :          IFX_INLINE IFX_INLINE uint8 Icu_lGetGtmModuleNo         **
**                                (                                          **
**                       Icu_17_GtmCcu6_ChannelIdentifierType ChannelId      **
**                                )                                          **
**                                                                           **
...
/******************************************************************************
** Syntax :     _IFXEXTERN_  IFX_INLINE uint8 Icu_lGetChannelType            **
**                                (Icu_17_GtmCcu6_ChannelType   Channel)     **
**                                                                           **
** Service ID:        none                                                   **
**                                                                           **
