...
#define IFX_VADC_ID_MOD_REV_LEN (8u)

/** \brief  Mask for Ifx_VADC_ID_Bits.MOD_REV */
#define IFX_VADC_ID_MOD_REV_MSK (0xffu)

/** \brief  Offset for Ifx_VADC_ID_Bits.MOD_REV */
#define IFX_VADC_ID_MOD_REV_OFF (0u)

/** \brief  Length for Ifx_VADC_ID_Bits.MOD_TYPE */
#define IFX_VADC_ID_MOD_TYPE_LEN (8u)

/** \brief  Mask for Ifx_VADC_ID_Bits.MOD_TYPE */
#define IFX_VADC_ID_MOD_TYPE_MSK (0xffu)

/** \brief  Offset for Ifx_VADC_ID_Bits.MOD_TYPE */
#define IFX_VADC_ID_MOD_TYPE_OFF (8u)
