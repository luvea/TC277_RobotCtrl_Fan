...
/** \brief  Length for Ifx_MC_MCONTROL_Bits.Res4 */
#define IFX_MC_MCONTROL_RES4_LEN (5u)

/** \brief  Mask for Ifx_MC_MCONTROL_Bits.Res4 */
#define IFX_MC_MCONTROL_RES4_MSK (0x1fu)

/** \brief  Offset for Ifx_MC_MCONTROL_Bits.Res4 */
#define IFX_MC_MCONTROL_RES4_OFF (10u)
